...
function SidebarInterviewer({ activeTab }: SidebarInterviewerProps) {
  ...
  const navItems: NavItem[] = [
    { id: "document", label: "Berkas Mahasiswa", link: "/interviewer/document", icon: <File className="h-5 w-5" /> },
    { id: "interview", label: "Jadwal Wawancara", link: "/interviewer/interview", icon: <Calendar className="h-5 w-5" /> },
    { id: "form", label: "Form Interview", link: "/interviewer/form", icon: <BookText className="h-5 w-5" /> },
  ]
