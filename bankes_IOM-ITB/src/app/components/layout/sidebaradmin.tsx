...
function SidebarAdmin({ activeTab }: SidebarAdminProps) {
  ...
  const navItems: NavItem[] = [
    { id: "account", label: "Manajemen Akun", link: "/admin/account", icon: <User className="h-5 w-5" /> },
    { id: "request", label: "Permohonan Persetujuan", link: "/admin/request", icon: <UserRoundPen className="h-5 w-5" /> },
    { id: "period", label: "Periode Bantuan", link: "/admin/period", icon: <Calendar className="h-5 w-5" /> },
  ]
          ...
          <div className="flex items-center space-x-3">
            ...
            {showFullContent && (
              <div className="min-w-0 flex-1">
                <h2 className="text-lg font-semibold text-gray-800 truncate">{userName || "Admin"}</h2>
