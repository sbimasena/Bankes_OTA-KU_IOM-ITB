export function registrationEmailToBankesAdmin(
  emailReceiverName: string,
  numberOfPendingApplicationMa: string,
  numberOfPendingApplicationOta: string,
  linkToVerifikasiAkun: string,
) {
  ...
  <div id="in2p" style="box-sizing: border-box; background-color: #f6f9fc;">
    ...
    <div id="ipt46" style="box-sizing: border-box; background: initial; background-color: initial; margin: 0px auto; max-width: 600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" id="its89" width="100%" bgcolor="initial" style="box-sizing: border-box; border-collapse: collapse; background: initial; background-color: initial; width: 100%;">
        <tbody id="ieele" style="box-sizing: border-box;">
    ...
    <div id="iepcq" style="box-sizing: border-box; background: initial; background-color: initial; margin: 0px auto; max-width: 600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" id="ihjxy" width="100%" bgcolor="initial" style="box-sizing: border-box; border-collapse: collapse; background: initial; background-color: initial; width: 100%;">
        <tbody id="ilg9t" style="box-sizing: border-box;">
          <tr id="i3h7f" style="box-sizing: border-box;">
            <td id="it1zd" align="center" style="box-sizing: border-box; border-collapse: collapse; direction: ltr; font-size: 0px; padding: 0 20px; text-align: center;">
              ...
              <div id="ioknp" class="mj-column-per-100 mj-outlook-group-fix shadow" style="box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.05) 0px 2px 5px; font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" id="i7ds7" valign="top" style="box-sizing: border-box; border-collapse: collapse; vertical-align: top;">
                  <tbody id="iiwa1" style="box-sizing: border-box;">
                    <tr id="ismkg" style="box-sizing: border-box;">
                      <td id="in7ux" style="box-sizing: border-box; border-collapse: collapse; font-size: 0px; padding: 20px 20px 0px 20px; word-break: break-word;">
                        ...
                        <div id="i68rm" style="box-sizing: border-box; background: #003399; background-color: #003399; margin: 0px auto; border-radius: 24px 24px 0px 0px; max-width: 560px;">
                          <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" id="i6h8x" width="100%" bgcolor="#003399" style="box-sizing: border-box; border-collapse: collapse; background: #003399; background-color: #003399; width: 100%; border-radius: 24px 24px 0px 0px;">
                            <tbody id="i6rji" style="box-sizing: border-box;">
                              <tr id="i4f7j" style="box-sizing: border-box;">
                                <td id="iotyl" align="center" style="box-sizing: border-box; border-collapse: collapse; direction: ltr; font-size: 0px; padding: 20px; text-align: center;">
                                  ...
                                  <div id="izuvj" class="mj-column-per-100 mj-outlook-group-fix" style="box-sizing: border-box; font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" id="iuv2i" valign="top" style="box-sizing: border-box; border-collapse: collapse; vertical-align: top;">
                                      <tbody id="i61qg" style="box-sizing: border-box;">
                                        <tr id="i6bxe" style="box-sizing: border-box;">
                                          <td align="center" id="i2igb" style="box-sizing: border-box; border-collapse: collapse; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                                            <div id="is4tk" style="box-sizing: border-box; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 700; line-height: 24px; text-align: center; color: #ffffff;">Notifikasi Verifikasi Pendaftaran
                                            </div>
                                          </td>
                                        </tr>
                                      </tbody>
                    ...
                    <tr id="iw43w" style="box-sizing: border-box;">
                      <td id="ifady" style="box-sizing: border-box; border-collapse: collapse; font-size: 0px; padding: 0px 20px 20px 20px; word-break: break-word;">
                        ...
                        <div id="iafos" style="box-sizing: border-box; background: #FFFFFF; background-color: #FFFFFF; margin: 0px auto; border-radius: 0px 0px 16px 16px; max-width: 560px;">
                          <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" id="iazru" width="100%" bgcolor="#FFFFFF" style="box-sizing: border-box; border-collapse: collapse; background: #FFFFFF; background-color: #FFFFFF; width: 100%; border-radius: 0px 0px 16px 16px;">
                            <tbody id="i8n1i" style="box-sizing: border-box;">
                              <tr id="ii009" style="box-sizing: border-box;">
                                  ...
                                  <div id="i574e" class="mj-column-per-100 mj-outlook-group-fix" style="box-sizing: border-box; font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" id="iiwr8" valign="top" style="box-sizing: border-box; border-collapse: collapse; vertical-align: top;">
                                      <tbody id="icoiw" style="box-sizing: border-box;">
                                        <tr id="ihv4h" style="box-sizing: border-box;">
                                          <td align="left" id="i3jt3" style="box-sizing: border-box; border-collapse: collapse; font-size: 0px; padding: 10px 0px 10px 0px; word-break: break-word;">
                                            <div id="ixfvo" style="box-sizing: border-box; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 24px; text-align: left; color: #003A6E;">
                                              <p data-start="153" data-end="164" id="i2igt" style="box-sizing: border-box; display: block; margin-top: 13px; margin-right: 0px; margin-bottom: 13px; margin-left: 0px;">Halo 
                                                <b id="ipfi8" style="box-sizing: border-box;">${emailReceiverName}
                                                </b>,
                                              </p>
                                              ...
                                              <p data-start="452" data-end="485" id="iut4gc" style="box-sizing: border-box; display: block; margin-top: 13px; margin-right: 0px; margin-bottom: 13px; margin-left: 0px;">Mohon segera lakukan verifikasi untuk akun tersebut melalui tautan tombol berikut:
                                              </p>
                                            </div>
                                          </td>
                                        </tr>
                                        <tr id="i807e" style="box-sizing: border-box;">
                                          <td align="center" vertical-align="middle" id="iycnam" style="box-sizing: border-box; border-collapse: collapse; font-size: 0px; padding: 12px 30px; word-break: break-word;">
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" id="i4p3wm" style="box-sizing: border-box; border-collapse: separate; line-height: 100%;">
                                              <tbody id="i11ug" style="box-sizing: border-box;">
                                                <tr id="ihgump" style="box-sizing: border-box;">
                                                  <td align="center" bgcolor="#003399" role="presentation" valign="middle" id="ivnb3k" style="box-sizing: border-box; border-collapse: collapse; border: none; border-radius: 4px; cursor: auto; mso-padding-alt: 10px 25px; background: #003399;">
                                                    <a href="${linkToVerifikasiAkun}" target="_blank" id="i4mvl2" style="box-sizing: border-box; display: inline-block; background: #003399; color: #ffffff; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 13px; font-weight: normal; line-height: 120%; margin: 0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 4px;">Verifikasi Sekarang</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                        ...
                                        <tr id="i1ot5h" style="box-sizing: border-box;">
                                        </tr>
                                        <tr id="iprasw" style="box-sizing: border-box;">
                                        </tr>
                                        <tr id="i3pvqc" style="box-sizing: border-box;">
                                        </tr>
                                        <tr id="i7oqm9" style="box-sizing: border-box;">
                                        </tr>
                                        <tr id="i8s9be" style="box-sizing: border-box;">
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
    ...
    <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" bgcolor="initial" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    <div id="inhldj" style="box-sizing: border-box; background: initial; background-color: initial; margin: 0px auto; border-radius: 0px 0px 16px 16px; max-width: 600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" id="iy5pxg" width="100%" bgcolor="initial" style="box-sizing: border-box; border-collapse: collapse; background: initial; background-color: initial; width: 100%; border-radius: 0px 0px 16px 16px;">
        <tbody id="iunijp" style="box-sizing: border-box;">
          <tr id="if9keq" style="box-sizing: border-box;">
            <td id="ida61g" align="center" style="box-sizing: border-box; border-collapse: collapse; direction: ltr; font-size: 0px; padding: 20px 0; text-align: center;">
              <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]-->
              <div id="ifnkjl" class="mj-column-per-100 mj-outlook-group-fix" style="box-sizing: border-box; font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" id="iqwv72" valign="top" style="box-sizing: border-box; border-collapse: collapse; vertical-align: top;">
                  <tbody id="iittj1" style="box-sizing: border-box;">
                    <tr id="i3ep9t" style="box-sizing: border-box;">
                      <td align="center" id="ignljf" style="box-sizing: border-box; border-collapse: collapse; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                        <div id="ixsznp" style="box-sizing: border-box; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 24px; text-align: center; color: #8898aa;">
