...
interface CatatanOrangTuaModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function CatatanOrangTuaModal({
  isOpen,
  onClose,
  item,
  note,
}: CatatanOrangTuaModalProps) {
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="space-y-2 pt-2">
            ...
            <div className="min-h-[120px] rounded-md border border-gray-200 bg-gray-50 p-3 text-sm whitespace-pre-wrap text-gray-800">
              {note || "Tidak ada catatan untuk OTA ini."}
            </div>
          </div>
        </div>
